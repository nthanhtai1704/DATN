                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="${pageContext.request.contextPath}/createproduct" novalidate="novalidate" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-3">Loại xe</label>
                                        <div class="col-lg-6">
                                            <!-- <input class=" form-control" id="lastname" name="species" type="text"> -->
                                        	<select name="species">
                                        		<option value="mer4">Mercedes 4 chỗ</option>
                                        		<option value="mer16">Mercedes 16 chỗ</option>
                                        		<option value="audi4">Audi 4 chỗ</option>
                                        		<option value="audi6">Audi 6 chỗ</option>
                                    ...
                                    <div class="form-group ">
                                     ...
                                     <div class="form-group ">
                                        <label for="agree" class="control-label col-lg-3 col-sm-3">Mô tả</label>
                                        <div class="col-lg-6 col-sm-9">
                                            <input class="form-control " id="email" name="status" type="text" required="required">
                                        </div>
                                    </div>
                                      <div class="form-group ">
                                        <label for="email" class="control-label col-lg-3">Giá</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="price" type="text" required="required">
                                        </div>
                                    </div>
