			...
			<div class="content-top">
				...
				<c:forEach items="${listpt}" var="product">
					<div class="col-md-4 grid-top simpleCart_shelfItem">
						<a href="${pageContext.request.contextPath}/login" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/${product.avatar}" alt="">
							<div class="b-wrapper">
					...
					<p><a href="${pageContext.request.contextPath}/login">${product.nameproduct}</a></p>
					<a href="${pageContext.request.contextPath}/login" class="item_add"><p class="number item_price"><i> </i>${product.price}</p></a>
					</div>
					<div class="col-md-4 grid-top simpleCart_shelfItem">
						<a href="${pageContext.request.contextPath}/login" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/${product.avatar}" alt="">
							<div class="b-wrapper">
