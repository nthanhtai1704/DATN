				...
				<!-- form-stars-here -->
						<div class="form-w3-agile">
							...
							<form action="login" method="POST">
								...
								<p class="p-bottom-w3ls">Quên mật khẩu?<a class href="fogotPassword">  Click here</a></p>
								<p class="p-bottom-w3ls1">Đăng ký<a class href="signUp">  Register here</a></p>
								<div class="clear"></div>
		...
		<!-- -728x90- -->
				...
				<!-- copyright -->
					<div class="copyright w3-agile">
						<p> © 2019 Login Form . All rights reserved</p>
					</div>
					<!-- //copyright --> 
        </div>
	</div>
