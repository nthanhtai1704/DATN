...
public class client_frame extends javax.swing.JFrame 
{
   ...
   //gửi thông tin ngắt kết nối
    ...
    private void initComponents() {
		...
		/*
		 * tf_address.setText("localhost"); tf_address.addActionListener(new
        ...
        b_anonymous.setText("Kiểm tra kết nối");
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (isConnected == false) 
        {
            ...
            try 
            {
            	//gán địa chỉ máy chỉ và cổng cho socket 
                sock = new Socket(address, port);
                //tạo biến để gửi dữ liệu đi
                InputStreamReader streamreader = new InputStreamReader(sock.getInputStream());
                reader = new BufferedReader(streamreader);
