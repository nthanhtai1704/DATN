...
public class server_frame extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable	
   {
       ...
       public ClientHandler(Socket clientSocket, PrintWriter user) 
       {
            ...
            try 
            {
                thanhtai = clientSocket;
                // tạo biến để nhận dữ liệu
                InputStreamReader isReader = new InputStreamReader(thanhtai.getInputStream());
    ...
    private void b_endActionPerformed(java.awt.event.ActionEvent evt) {
        try 
        {
            Thread.sleep(5000);   // cho chương trình chờ trong 5  giây ,5000 milliseconds tương ứng với 5 giây.
        } 
    ...
    public class ServerStart implements Runnable 
    {
        ...
        public void run() 
        {
            ...
            try 
            {
            	//Khai báo socket cho server với cổng là 3443
                ServerSocket serverSock = new ServerSocket(3443);
